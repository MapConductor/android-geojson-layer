 ...
 * タイルにかかるセルだけを辿る。
 *
 * ios-sdk / react-sdk の同名ファイルと同じ作り。
 */
internal class GeoJSONSpatialIndex(
    ...
    companion object {
        ...
        fun build(features: List<RenderFeature>): GeoJSONSpatialIndex {
            ...
            return GeoJSONSpatialIndex(grid, features.size)
        }
    }
}
